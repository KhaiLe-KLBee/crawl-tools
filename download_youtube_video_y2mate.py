...
class handle_download_youtube_video_y2mate:
    ...
    def downloadVideo(self):
        '''
        Tải video khi biết link, folder_path, fileName
    ...
    def reset(self, folder_path = ''):
        '''
        Reset các value trong class trừ folder path, nếu muốn thay đổi thì truyền path khác vào hàm
        '''
        self.__youtubeUrl = ''
        self.__limitQuantity = ''
        self.__file_name = ''
        if folder_path != '':
            self.__folder_path = folder_path
        self.__direct_link = ''
